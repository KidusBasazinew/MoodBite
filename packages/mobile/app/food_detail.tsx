      ...
      <SafeAreaProvider>
         <SafeAreaView edges={['top']}>
            <ScrollView>
               <ImageBackground
                  source={{
                     uri: 'https://img.freepik.com/free-photo/penne-pasta-tomato-sauce-with-chicken-tomatoes-wooden-table_2829-19739.jpg?w=740&q=80',
                  }}
                  ...
                  <View className="flex flex-col gap-y-2">
                     ...
                     <View className="flex-row items-center h-20 bg-orange-50 rounded-lg mx-5 px-3 shadow-sm">
                        <View className="w-10 h-10 items-center justify-center">
                           <Image source={mood} className="w-10 h-10" />
                        </View>
